...
membeli_fashion = pembayaran_pajak - (pembayaran_pajak * (10/100))
membeli_alat = pendapatan_kotor -(pendapatan_kotor * (1/100))
...
print('Jumlah Uang Budi Untuk Membeli fashion: Rp. ' , membeli_fashion)
print('Jumlah Uang Budi Untuk Membeli Alat: Rp. ' , membeli_alat)
